...
const Register = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    let response;
    try {
      response = await axios.post('/api/user-register', e)
  ...
  return (
    <div className='flex items-center justify-center'>
      <div className='h-screen flex flex-col justify-center items-center mx-auto md:mx-4'>
        {
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className='b min-w-96 min-h-[50%] bg-green-700 text-white p-8 rounded-xl'>
          <div className='text-center mb-5'>
            ...
            <h1 className='text-3xl text-yellow-300 mt-2'>Register</h1>
          </div>
          <div>
      ...
      {/* <div className='md:w-[75%] md:h-screen rounded--full'>
      </div> */}
    </div>
  )
}
